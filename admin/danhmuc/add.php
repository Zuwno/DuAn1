<div class="bg-[#F0EFEF]  border">
            <section class="bg-white mt-10">
                <div class="pl-[24%] m-10 ">
                    <h1 class="text-[25px] py-10 text-gray-600 font-semibold border-black border-b-2">THÊM LOẠI HÀNG</h1>

                    <form action="index.php?act=adddm" method="post" onsubmit="return validate()">
                    <div class="grid grid-cols-[30%,auto]">
                        <div class="py-5 pl-5 ">
                            <label class="" for="">Tên loại hàng</label><span class="text-red-600">*</span>
                        </div>
                        <div>
                            <input class="border  border-gray-600 p-2 m-3 w-[50%] rounded-lg" type="text" name="tenloai" id="tenloai">
                    ...
                    <div class="grid grid-cols-[30%,auto]">
                        ...
                        <div>
                            <input class="border  border-gray-600 p-2 m-3 w-[50%] rounded-lg" type="text" name="detail" id="detail">
            ...
            <?php 
                if(isset($thongbao) && $thongbao!="") { ?>
                    <script>
                        window.location.href = 'http://localhost/duan1/DA1/Admin/index.php?act=listdm';
                    </script>
            <?php } ?>
                    </form>
