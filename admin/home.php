        ...
        <div class="grid grid-cols-4 mt-5 gap-6 dropdown ">
            <a href="index.php?act=listdm">
                <div class="bg-white p-6 rounded-lg shadow-lg transition  hover:scale-110  delay-100  duration-300 relative hover:cursor-grabbing">
                    ...
                    <div class="text-3xl font-medium leading-8 mt-6"><?php echo $soluongloaihangtr['total']; ?></div>
            ...
            <a href="index.php?act=listsp">
                <div class="bg-white p-6 rounded-lg shadow-lg transition  hover:scale-110  delay-100  duration-300 relative hover:cursor-grabbing">
                    ...
                    <div class="text-3xl font-medium leading-8 mt-6"><?php echo $soluongsanphamtr['total']; ?></div>
            ...
            <a href="index.php?act=dskh">
                <div class="bg-white p-6 rounded-lg shadow-lg transition  hover:scale-110  delay-100  duration-300 relative hover:cursor-grabbing">
                    ...
                    <div class="text-3xl font-medium leading-8 mt-6"><?php echo $soluongtaikhoantr['total']; ?></div>
            ...
            <a href="index.php?act=dsblc">
                <div class="bg-white p-6 rounded-lg shadow-lg transition  hover:scale-110  delay-100  duration-300 relative hover:cursor-grabbing">
                    ...
                    <div class="text-3xl font-medium leading-8 mt-6"><?php echo $binhluandangxetduyettr['total']; ?></div>
        ...
        <div class="grid grid-cols-4 mt-5 gap-6 dropdown ">
            <a href="index.php?act=dsbl">
                <div class="bg-white p-6 rounded-lg shadow-lg transition  hover:scale-110  delay-100  duration-300 relative hover:cursor-grabbing">
                    ...
                    <div class="text-3xl font-medium leading-8 mt-6"><?php echo $binhluandaxetduyettr['total']; ?></div>
            ...
            <a href="index.php?act=listbill">
                <div class="bg-white p-6 rounded-lg shadow-lg transition  hover:scale-110  delay-100  duration-300 relative hover:cursor-grabbing">
                    ...
                    <div class="text-3xl font-medium leading-8 mt-6"><?php echo $soluongdonhangtr['total']; ?></div>
                    <div class="text-base text-slate-500 mt-1">Số lượng đơn hàng</div>
