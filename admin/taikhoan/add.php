            ...
            <div class="pl-[24%] m-10 ">
                ...
                <form action="">
                    <div class="grid grid-cols-[30%,auto]">
                        ...
                        <div>
                            <input class="border  border-gray-600 p-2 m-3 w-[50%] rounded-lg" type="text">
                        </div>
                    ...
                    <div class="grid grid-cols-[30%,auto]">
                        ...
                        <div>
                            <input class="border  border-gray-600 p-2 m-3 w-[50%] rounded-lg" type="file">
                        </div>
                    ...
                    <div class="grid grid-cols-[30%,auto]">
                        ...
                        <div>
                            <input class="border  border-gray-600 p-2 m-3 w-[50%] rounded-lg" type="email">
                        </div>
                    ...
                    <div class="w-full text-center  block">
                        <input type="submit" class="py-2 px-4 rounded-lg my-3 bg-black text-white  items-center"
