...
<body>
    ...
    <body>
        <section id="main-me" class="w-[22%] h-[1000px] bg-[#1B4643]  fixed  text-white top-0 left-0 z-[999px] ">
            ...
            <div>
                <img src="" alt="">
                <h3 class="px-10 pt-4">Welcome Admin</h3>
            </div>
                        <div class="px-10 pt-5">
                <ul class="space-y-3">
                    <li class="flex text-[17px] space-x-3">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24"
                            stroke="currentColor" stroke-width="2">
                            <path stroke-linecap="round" stroke-linejoin="round"
                                d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6" />
                        </svg><a href="index.php?act=home">home</a>
                    </li>
                    ...
                    <li class="flex text-[17px] space-x-3 ">
                        ...
                        <a href="index.php?act=listdm">Loại hàng</a>
                    </li>
                    <li class="flex text-[17px] space-x-3 ">
                    ...
                    <li class="flex text-[17px] space-x-3 ">
                        ...
                        <a href="index.php?act=dskh"> Quản lí admin</a>
                    </li>
                    <li class="flex text-[17px] space-x-3 ">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                            stroke="currentColor" class="w-6 h-6">
                        ...
                        <a href="index.php?act=dsblc">Bình luận đang xét duyệt</a>
                    </li>
                    <li class="flex text-[17px] space-x-3 ">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                            stroke="currentColor" class="w-6 h-6">
                        ...
                        <a href="index.php?act=dsbl">Bình luận đã xét duyệt</a>
                    </li>
                    <li class="flex text-[17px] space-x-3 ">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                         stroke="currentColor" class="w-6 h-6">
                        ...
                        <a href="index.php?act=dslh">Danh sách liên hệ</a>
                    </li>
                    <li class="flex text-[17px] space-x-3 ">
