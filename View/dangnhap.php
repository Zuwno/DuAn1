...
<link rel="shortcut icon" href="//theme.hstatic.net/200000557063/1000907375/14/favicon.png?v=1162" type="image/png">
 ...
 <style>
    :root {
    --primary-color: #ea80be;
    --secondary-color: #ea80be;
    --black: #000000;
    --white: #ffffff;
    --gray: #efefef;
    --gray-2: #757575;
        ...
        if (isset($_POST['btnn_submit'])) {
          ...
          if ($kq->rowCount() == 1) {
            ...
            header_remove("Location");
              ...
              echo '<span style="color:red;font-size:12px;">Tài khoản hoặc email sai</span>';
          }
      }
      ?>
						<button style="margin-top:8px" type="submit" name="btnn_submit">
							Xác nhận
						</button>
                        
						<p>
							<span>
								Bạn có sẵn sàn tìm lại mật khẩu?
							</span>
				...
				<div class="form-wrapper align-items-center">
					<div class="form sign-in">
						<div class="input-group">
							<i class='bx bxs-user'></i>
                            <form action="" method="post">
							<input type="text" placeholder="Tài khoản" name="username" require>
						</div>
						<div class="input-group">
						...
						<button style="margin-top:8px" type="submit" value="Đăng Nhập" name="submit">
							Đăng nhập
						</button>
                    </form>
