            ...
            <div class="">
              <div class="px-8 text-[#494747]">
                ...
                <div class="border border-[#e76ea5] rounded-lg">
                  ...
                  <form action="" method="post" class="px-8">
                    <input type="text" class="border border-[#e76ea5] w-[40%] rounded-md px-2 py-1.5 mb-6" placeholder="Điện thoại...">
                    <button class="border border-[#e76ea5] text-white hover:bg-[#F8A4C4] rounded-md px-2 mx-1 py-1.5 font-[600] bg-[#e76ea5] "><a href="">àng & nhận tư vấn </a></button>
                  </form>
