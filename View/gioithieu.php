    ...
    <header class="nav-main box-border">
      ...
      <section class="">
        <div>
            ...
            <h2  class="text-white font-bold text-[38px] ">GIỚI THIỆU TAEHUI VIỆT NAM</h2>
            <span class="text-white text-[17px] "><a href="index.php">Trang chủ</a>  <i class="fa fa-angle-right" aria-hidden="true"></i><a href=""> Giới thiệu TaeHui Việt Nam</a> </span>
        </div>
        </div>
    </section>
    </header>
    <main class="max-w-7xl m-auto text-[#545454]">
      <article class="">
        <h1 style="font-size:45px;" class="font-bold  text-[#545454]">Giới thiệu Taehui Việt Nam</h1>
        <img class="imggg m-auto w-[600px] h-[161px] mt-10" src="../imgs/header_logo.png" alt="">
