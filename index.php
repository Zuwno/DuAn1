...
<body>
  <article class="">
    ...
    <!-- <header class="nav-main max-w-8xl m-auto py-4 ">
    <div class="flex items-center justify-between md:justify-center">
    <button id="btn" class="md:hidden right-0 absolute px-4 md:px-0">
      <img class="" src="https://img.icons8.com/ios-glyphs/30/000000/menu--v1.png"/>
    </button>
   <a href=""><img class=" w-[200px] h-[80px] m-auto pb-4" src="imgs/header_logo.png"alt=""></a>
</div>
   <ul id="menu"  class=" md:flex justify-center items-center space-x-8 font-[700] text-[14px] hidden md:block  ">
    <li class="text-[#f84689] border border-[#F84689] py-1 px-4"><a href="">TRANG CHỦ</a></li>
    <li class="hover:text-[#f84689] border-[#F84689]"><a href="">GIỚI THIỆU</a></li>
    
     <li  class="">
      <div class="flex">
      <a href=""class="hover:text-[#f84689]"> COLLAGEN TAEHUI PINK C</a>
      </div>
      <ul class="list-sanPham px-4 w-[200px] border border-[#bbb] divide-y">
        <li class="text-[#777] hover:text-[#555] font-[400]  py-2"><a href="">HỘP ĐƠN</a></li> <hr>
        <li class="text-[#777] hover:text-[#555] font-[400]  py-2"><a href="">COMBO 2 HỘP</a></li>
        <li class="text-[#777] hover:text-[#555] font-[400]  py-2"><a href="">COMBO 3 HỘP</a></li>
      </ul>
      <style>
        .list-sanPham{
    background-color:white;
...
.nav-main ul li:hover .list-sanPham{
    ...
    <li  class ="hover:text-[#f84689]"><a href="">KIẾN THỨC COLLAGEN</a></li>
    
    <li>
      <div class="flex">
        <a href="tintuc.php" class="hover:text-[#f84689]">TIN TỨC</a>
    
    </div>
    <ul class="list-sanPham px-4 w-[200px] border border-[#bbb] divide-y">
      <li class="text-[#777] hover:text-[#555] font-[400]  py-2"><a href="">GÓC LÀM ĐẸP</a></li> <hr>
      <li class="text-[#777] hover:text-[#555] font-[400]  py-2"><a href="">TIN TỨC TAEHUI</a></li>
    </ul>
    <style>
      .list-sanPham{
  background-color:white;
...
.nav-main ul li:hover .list-sanPham{
  display: block;
    ...
    <li  class="hover:#f84689]"><a href="lienHe.php">LIÊN HỆ</a></li>
    <li  class="hover:text-[#f84689]"><a href="">HỆ THỐNG PHÂN PHỐI</a></li>
   </ul>
  <script>
